...
public class TC_FUNC_0003_VerifyAdditionOfTwoZeroNumbersTest extends TestBase{
	
	PropineAdditionCalculatorPage propAddCalPage;
	String sheetName = "TC_FUNC_0003";
	
	public TC_FUNC_0003_VerifyAdditionOfTwoZeroNumbersTest(){
		super();
	}
	...
	public void TC_FUNC_0003_verifyAdditionOfTwoZeroNumbersTest(String first_num, String second_num, String sum) throws InterruptedException {
		...
		//System.out.println(sum);		
		Assert.assertEquals(resultsSum, sum, "Addition of two Zero numbers - FAILED");
	}
