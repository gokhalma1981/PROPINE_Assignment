...
public class TC_FIELD_0003_VerifyFirstNumberForNonNumericValuesTest extends TestBase{
	
	PropineAdditionCalculatorPage propAddCalPage;
	String sheetName = "TC_FIELD_0003";
	
	public TC_FIELD_0003_VerifyFirstNumberForNonNumericValuesTest(){
		super();
	}
	...
	public void TC_FIELD_0003_verifyFirstNumberForNonNumericValuesTest(String first_num) throws InterruptedException{
		...
		Assert.assertNotEquals(firstNumberValue, first_num, "Field verification for Non-Numeric Values - FAILED");	
	}
