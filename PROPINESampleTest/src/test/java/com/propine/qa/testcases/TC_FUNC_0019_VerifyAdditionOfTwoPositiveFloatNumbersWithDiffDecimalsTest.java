...
public class TC_FUNC_0019_VerifyAdditionOfTwoPositiveFloatNumbersWithDiffDecimalsTest extends TestBase{
	
		PropineAdditionCalculatorPage propAddCalPage;
		String sheetName = "TC_FUNC_0019";
		
		public TC_FUNC_0019_VerifyAdditionOfTwoPositiveFloatNumbersWithDiffDecimalsTest(){
			super();
		}
		...
		public void TC_FUNC_0019_verifyAdditionOfTwoPositiveFloatNumbersWithDiffDecimalsTest(String first_num, String second_num, String sum) throws InterruptedException{
